...
// const modalImage = document.querySelector("#modal-name");
// const modalImage = document.querySelector("#modal-species");
// const modalImage = document.querySelector("#modal-gender");
// const modalImage = document.querySelector("#modal-origin");
// const modalImage = document.querySelector("#modal-location");
// const modalImage = document.querySelector("#modal-status");
